...
//            String issuer = JwtHelper.extractIssuer(token); // utility you create (see below)
//
//            JwtDecoder decoder = decoderFactory.getDecoder(issuer);
...
//    private MultiTenantJwtDecoderFactory staticDecoderFactory;
//
//    @Autowired(required = false)
...
//            JwtDecoder decoder;
//
//            if (issuerProperties.getMode() == TenantMode.STATIC) {
//                decoder = staticDecoderFactory.getDecoder(issuer);
//            } else {
//                decoder = dynamicDecoderFactory.getDecoder(issuer);
//            }
//
//            JwtAuthenticationProvider provider = new JwtAuthenticationProvider(decoder);
//            provider.setJwtAuthenticationConverter(authenticationConverter);
